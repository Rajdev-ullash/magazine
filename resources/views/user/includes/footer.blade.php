    ...
    <div class="container px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between md:items-end items-start mb-8 md:mb-20">
            <div class="pl-2 mb-8 md:mb-0 md:pl-0 md:max-w-[50%]">
                <h3
                    class="text-3xl md:text-4xl lg:text-6xl font-bold text-neutral-950 dark:text-neutral-dark-950 leading-tight">
                    <span class="font-light">প্রতিদিন স্বাস্থ্যসেবা সম্পর্কিত</span> তথ্য, অফার ও আপডেট পেতে আমাদের
            ...
            <div class="mb-12 md:mb-0">
                <form class="max-w-full overflow-hidden" action="#">
                    <div
                        class="flex flex-col md:flex-row mb-4 md:bg-neutral-0 dark:bg-neutral-dark-200 rounded-full p-1 md:border border-neutral-300 dark:border-neutral-dark-300">
                        <input
                            class="focus:outline-none transition duration-200 py-4 bg-neutral-0 dark:bg-neutral-dark-200 rounded-full pl-6 w-full mb-2 md:mb-0 md:border-0 border border-neutral-300 dark:border-neutral-dark-300 "
                            type="text" placeholder="Email address">
                        <button
                            class="w-full sm:w-auto h-14 py-4 px-6 rounded-full bg-primary-light-950 dark:bg-primary-dark-950 transition duration-200 flex items-center justify-center gap-2"
                            type="submit">
                            <svg width="22" height="18" viewBox="0 0 22 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 fill-neutral-950"
                            ...
                            <span class="text-neutral-950 font-medium text-2xl">সাবস্ক্রাইব</span>
                        </button>
                    </div>
                    <div class="flex items-start justify-start mt-8 pl-4">
                        <input id="checkbox" type="checkbox"
                            class="w-4 h-4 accent-primary-light-950  bg-primary-light-950 text-neutral-0  rounded cursor-pointer">
                        <label for="checkbox" class="text-neutral-700 text-sm ml-2 cursor-pointer">I agree to the
                            <a href="#" class="text-neutral-950 dark:text-neutral-dark-950 font-bold">Terms
                                & conditions</a></label>
                    </div>
                </form>
            </div>
                ...
                <div class="mb-4">
                    ...
                    <ul>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='category.html'>Trending</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='category-2.html'>Fashion</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='category-3.html'>Technology</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='category-4.html'>Healthy</a>
                        </li>
                    </ul>
                </div>
                <div class="mb-4">
                    ...
                    <ul>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-about.html'>About me</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-contact.html'>Contact</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-author.html'>Author</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-search'>Search results</a>
                        </li>
                    </ul>
                </div>
                <div class="mb-4">
                    ...
                    <ul>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-register.html'>Register</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                        ...
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-forgot-password'>Forgot Password</a>
                        </li>
                        <li class="footer-menu">
                            <a class='text-base font-regular text-neutral-950 dark:text-neutral-dark-950'
                                href='page-404.html'>404</a>
                        </li>
                    </ul>
                </div>
            </div>
