    ...
    <div class="container flex justify-between items-center relative px-4">
        <h1>
            <a href='index.html'>
                ...
                <img src="{{ asset('/imgs/template/logo-white.svg') }}" alt="logo"
                    class="flex-shrink-0 relative hidden dark:inline-block">
            </a>
        </h1>
        <ul class="xl:flex hidden">
            <li class="relative group">
                <a class='menu-item' href='{{ URL::to('/') }}'>Home</a>
            </li>
            <li class="relative group">
                <a class="menu-item" href="#">Category</a>
                <ul
                        ...
                        @foreach ($featuredArticles as $features)
                            <div class="flex flex-col gap-4">
                                ...
                                <div class="flex gap-6 content-center hover-up">
                                    <div class="max-w-28">
                                        <a class='inline-block md:mb-0 overflow-hidden rounded-2xl' href='{{ URL::to('article/' . $article->slug) }}'>
            ...
            <li class="relative"><a class='menu-item' href='page-contact.html'>Contact</a></li>
        </ul>
        <div class="flex justify-end align-middle content-center items-center relative gap-4">
                ...
                <div class="relative size-6 z-10">
                    <div
                        ...
                        <div class="language__el bg-neutral-0 dark:bg-neutral-dark-0 cursor-pointer is-active "
                            ...
                            <div class="language__link flex gap-2 items-center">
                                <img class="language__img size-6" alt="en"
                                    src="{{ asset('user/imgs/template/flag-england.svg') }}" />
                                <span
                        ...
                        <div class="language__el bg-neutral-0 dark:bg-neutral-dark-0 cursor-pointer" data-lang="fr">
                            <div class="language__link flex gap-2 items-center">
                                <img class="language__img size-6" alt="fr"
                                    src="{{ asset('user/imgs/template/flag-france.svg') }}" />
                                <span
                        ...
                        <div class="language__el bg-neutral-0 dark:bg-neutral-dark-0 cursor-pointer" data-lang="vn">
                            <div class="language__link flex gap-2 items-center">
                                <img class="language__img size-6" alt="vn"
                                    src="{{ asset('user/imgs/template/flag-vietnam.svg') }}" />
                                <span
                                    class="language__text text-sm text-neutral-700 dark:text-neutral-dark-300">Vietnamese</span>
                            </div>
                        </div>
            ...
            <div class="dark-light cursor-pointer flex relative z-20">
                <img src="{{ asset('user/imgs/template/icon-dark-light.svg') }}" alt="dark/light" class="dark:hidden">
                <img src="{{ asset('user/imgs/template/icon-dark-light-white.svg') }}" alt="dark/light"
                    class="hidden dark:inline-block">
            </div>
            <div class="search-box flex relative py-4 z-20">
                <div class="search-icon cursor-pointer flex pr-2">
                    <img src="{{ asset('user/imgs/template/icon-search.svg') }}" alt="dark/light"
                        class="flex-shrink-0 relative dark:hidden">
                ...
                <nav class="relative p-6 h-full overflow-y-auto">
                    <div class="flex flex-col h-full">
                        ...
                        <ul class="py-6 mb-6 border-y border-neutral-300 dark:border-neutral-dark-300">
                            ...
                            <li class="has-children">
                                <a class="menu-mobile-item" href="#">Category</a>
                                <ul class="sub-menu">
                                    @foreach ($categories as $category)
                                        <li><a class='menu-mobile-sub-item'
